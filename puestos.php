                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="puesto" class="label-required">Puesto</label>
                                                            <input class="form-control input-sm upper" type="text" name="puesto" id="puesto" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12 col-sm-12">
                                                    <label for="tipo_puesto">Tipo</label>
                                                    <select id="tipo_puesto" name="tipo_puesto" class="form-control"></select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-12 col-sm-12">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="comision" name="comision" value="1">
