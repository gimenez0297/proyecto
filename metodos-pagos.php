                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="metodo_pago" class="label-required">Método De Pago</label>
                                                                <input class="form-control input-sm" type="text" name="metodo_pago" id="metodo_pago" autocomplete="off" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            <label for="orden" class="label-required">Orden</label>
                                                            <input class="form-control input-sm text-right" type="text" name="orden" id="orden" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)" required>
                                                        </div>
                                                        <div class="form-group col-md-6 col-sm-12">
                                                            <label for="sigla" class="label-required">Sigla</label>
                                                            <input class="form-control input-sm upper" type="text" name="sigla" id="sigla" autocomplete="off"ssss required>
                                                        </div>
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input" id="entidad" name="entidad" value="1">
                                                                <label class="custom-control-label" for="entidad">Entidad</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
