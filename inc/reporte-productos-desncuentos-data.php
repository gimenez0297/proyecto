<?php
    ...
    switch ($q) {
        ...
        case 'editar-comision':
            ...
            $comision    = quitaSeparadorMiles($db->clearText($_POST['comision']));
            ...
            $db->setQuery("UPDATE productos SET comision = $comision WHERE id_producto = $id_producto;");
            if (!$db->alter()) {
        ...
        case 'actualizar-comision':
            ...
            $db->setQuery("UPDATE productos SET comision = $comision
