var url = 'inc/tipo-comprobante-data';
        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id: row.id_tipo_comprobante, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$("#tabla").bootstrapTable({
    ...
    columns: [
        [
            { field: 'id_tipo_comprobante', title: 'ID Especialidad', align: 'left', valign: 'middle', sortable: true, visible: false },
            { field: 'codigo', title: 'Codigo', align: 'center', valign: 'middle', sortable: true },
            { field: 'nombre_comprobante', title: 'Nombre del Comprobante', align: 'left', valign: 'middle', sortable: true },
...
$('#agregar').click(function() {
    $('#modalLabel').html('Agregar Comprobante');
...
$('#eliminar').click(function() {
    ...
    sweetAlertConfirm({
        title: `Eliminar`,
        text: `¿Eliminar el Comprobante: ${nombre}?`,
        closeOnConfirm: false,
        confirm: function() {
            $.ajax({
                dataType: 'json',
...
function editarDatos(row) {
    resetForm('#formulario');
    $('#modalLabel').html('Editar Comprobante');
    $('#formulario').attr('action', 'editar');
    $('#eliminar').show();
    $('#modal').modal('show');

    $("#id").val(row.id_tipo_comprobante);
    $("#nombre").val(row.nombre_comprobante);
