        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id_laboratorio: row.id_laboratorio, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$('#agregar').click(function() {
    $('#modalLabel').html('Agregar Laboratorios');
...
$('#eliminar').click(function() {
    var id = $("#id_laboratorio").val();
    var laboratorio = $("#laboratorio").val();

    sweetAlertConfirm({
        title: `Eliminar`,
        text: `¿Eliminar Laboratorio: ${laboratorio}?`,
        closeOnConfirm: false,
        confirm: function() {
            $.ajax({
                dataType: 'json',
                ...
                url: url,
                cache: false,
                data: { q: 'eliminar', id, laboratorio },	
                beforeSend: function() {
                    NProgress.start();
                },
...
function editarDatos(row) {
    resetForm('#formulario');
    $('#modalLabel').html('Editar Laboratorio');
    $('#formulario').attr('action', 'editar');
    $('#eliminar').show();
    $('#modal').modal('show');

    $("#id_laboratorio").val(row.id_laboratorio);
    $("#laboratorio").val(row.laboratorio);
}
