var url = 'inc/administrar-cargas-premios-data';
...
window.accionesFila = {
    'click .ver-productos': function(e, value, row, index) {
        ...
        $('#tabla_productos').bootstrapTable('refresh', { url: url+'?q=ver_productos&id_cargas_premios='+row.id_cargas_premios });
    },
        ...
        sweetAlertConfirm({
            ...
            confirm: function() { 
                $.ajax({
                    ...
                    type: 'post',
                    data: { id: row.id_cargas_premios, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$("#tabla").bootstrapTable({
    ...
    sortName: "id_cargas_premios",
    sortOrder: 'desc',
    trimOnSearch: false,
    columns: [
        [
            { field: 'id_cargas_premios', title: 'ID', align: 'left', valign: 'middle', sortable: true, visible: false },
...
$("#tabla_productos").bootstrapTable({
    ...
    sortName: "codigo",
    sortOrder: 'asc',
    uniqueId: 'id_cargas_premios_productos',
    footerStyle: bstFooterStyle,
    columns: [
        [
            { field: 'id_cargas_premios_productos', title: 'ID PREMIO', align: 'left', valign: 'middle', sortable: true, visible: false },
            { field: 'id_cargas_premios', title: 'ID CARGA', align: 'left', valign: 'middle', sortable: true, visible: false },
