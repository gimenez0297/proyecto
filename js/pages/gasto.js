...
$('#id_tipo_gasto').select2({
    ...
    ajax: {
        ...
        data: function (params) {
            return { q: 'sub_tipos_gastos', term: params.term, page: params.page || 1 }
        },
        processResults: function (data, params) {
            params.page = params.page || 1;
            return {
                results: $.map(data.data, function (obj) { return { id: obj.id_sub_tipo_gasto, text: obj.nombre }; }),
        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id: row.id_tipo_gasto, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$("#tabla").bootstrapTable({
    ...
    height: alturaTabla(),
    pageSize: pageSizeTabla(),
    sortName: "id_tipo_gasto",
    sortOrder: 'asc',
    trimOnSearch: false,
    columns: [
        [
            { field: 'id_tipo_gasto', title: 'ID Gasto', align: 'left', valign: 'middle', sortable: true, visible: false },
            { field: 'id_sub_tipo_gasto', title: 'ID Tipo de Gasto', align: 'left', valign: 'middle', sortable: true, visible: false },
            { field: 'nombre', title: 'Gasto', align: 'left', valign: 'middle', sortable: true },
            { field: 'tipo_gasto', title: 'Tipo de Gasto', align: 'left', valign: 'middle', sortable: true },
...
function editarDatos(row) {
    ...
    $("#id").val(row.id_tipo_gasto);
    $("#nombre").val(row.nombre);

    if (row.id_sub_tipo_gasto > 0) {
        $('#id_tipo_gasto').select2('trigger', 'select', {
            data: { id: row.id_sub_tipo_gasto, text: row.tipo_gasto}
        });
    }
}
