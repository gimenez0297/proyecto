        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id_origen: row.id_origen, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$('#agregar').click(function() {
    $('#modalLabel').html('Agregar Origen');
...
$('#eliminar').click(function() {
    var id = $("#id_origen").val();
    var origen = $("#origen").val();

    sweetAlertConfirm({
        title: `Eliminar`,
        text: `¿Eliminar Origen: ${origen}?`,
        closeOnConfirm: false,
        confirm: function() {
            $.ajax({
                dataType: 'json',
...
function editarDatos(row) {
    resetForm('#formulario');
    $('#modalLabel').html('Editar Origen');
    $('#formulario').attr('action', 'editar');
    $('#eliminar').show();
    $('#modal').modal('show');

    $("#id_origen").val(row.id_origen);
    $("#origen").val(row.origen);
}
