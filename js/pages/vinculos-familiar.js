var url = 'inc/vinculos-familiar-data';
        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id_vinculo: row.id_vinculo_familiar, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$("#tabla").bootstrapTable({
    ...
    columns: [
        [
            { field: 'id_vinculo_familiar', title: 'ID', align: 'left', valign: 'middle', sortable: true, visible: false },
            { field: 'vinculo', title: 'Vínculo', align: 'left', valign: 'middle', sortable: true, cellStyle: bstTruncarColumna },
...
$('#agregar').click(function() {
    $('#modalLabel').html('Agregar Vínculo');
...
function editarDatos(row) {
    ...
    $("#id_vinculo").val(row.id_vinculo_familiar);
    $("#vinculo").val(row.vinculo);
}
