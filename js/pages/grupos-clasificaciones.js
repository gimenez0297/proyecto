var url = 'inc/grupos-clasificaciones-data';
        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id_grupo: row.id_grupo, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
