var url = 'inc/servicio-venta-data';
        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id: row.id_producto, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$("#tabla").bootstrapTable({
    ...
    columns: [
        [
            ...
            { field: 'producto', title: 'Servicio', align: 'left', valign: 'middle', sortable: true },
            { field: 'precio', title: 'Precio', align: 'right', valign: 'middle', sortable: true, formatter: separadorMiles },
            { field: 'iva_str', title: 'Iva', align: 'right', valign: 'middle', sortable: true, visible: true},
...
$('#agregar').click(function() {
    $('#modalLabel').html('Agregar Servicio');
...
$('#eliminar').click(function() {
    ...
    sweetAlertConfirm({
        title: `Eliminar`,
        text: `¿Eliminar el Servicio: ${nombre}?`,
        closeOnConfirm: false,
        confirm: function() {
            $.ajax({
                dataType: 'json',
...
function editarDatos(row) {
    resetForm('#formulario');
    $('#modalLabel').html('Editar Servicio');
    $('#formulario').attr('action', 'editar');
    $('#eliminar').show();
    $('#modal').modal('show');

    $("#id").val(row.id_producto);
    $("#codigo").val(row.codigo);
    $("#servicio").val(row.producto);
