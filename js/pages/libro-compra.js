...
var url = 'inc/libro-compra-data.php';
...
$("#tabla").bootstrapTable({
    ...
    columns: [
        [
            { field: 'tipo_registro', title: 'Tipo Reg.', align: 'center', valign: 'middle', width: 8 },
            ...
            { field: 'codigo', title: 'Tipo Comprobante', align: 'center', valign: 'middle', width: 8 },
            { field: 'fecha_emision_str', title: 'Fecha de Emisión', align: 'center', valign: 'middle', sortable: true },
            { field: 'timbrado', title: 'Timbrado', align: 'center', valign: 'middle' },
            { field: 'documento', title: 'Nro. Comprobante', align: 'center', valign: 'middle', sortable: true },
            ...
            { field: 'extenta', title: 'Exenta', align: 'right', valign: 'middle', sortable: true ,formatter: separadorMiles},
            { field: 'monto', title: 'Imp. Total', align: 'right', valign: 'middle', sortable: true, formatter: separadorMiles},
            ...
            { field: 'no_imputa', title: 'No Imp', align: 'center', valign: 'middle',  visible: true },
            { field: 'nro_comprobante_venta_asoc', title: 'Nro. comp. asociada', align: 'right', valign: 'middle',  visible: true },
            { field: 'timb_compro_venta_asoc', title: 'Nro. timb. asociada', align: 'right', valign: 'middle',  visible: true },
        ]
    ]
});
...
$('#btn_buscar').on('click', function (e) {
    ...
    $("#tabla").bootstrapTable("refresh", { url: url + '?q=ver&desde=' + desde + '&hasta=' + hasta + '&proveedor=' + proveedor});
...
$("#imprimir").on("click", function (e) {
    ...
    OpenWindowWithPost("imprimir-libro-compra", "toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=yes,resizable=yes,width=850,height=650", "imprimirLibroDeCompra", param);
    resetForm();
  });
...
$("#exportar").on("click", function (e) {
    ...
    window.location.replace(`exportar-libro-compra-rg90.php?${$.param(param)}`);
    resetForm();
  });
...
function resetForm() {
    ...
    $('#proveedores').find('select').val(null).trigger('change');
}
