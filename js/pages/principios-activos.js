var url = 'inc/principios-activos-data';
        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id_principio: row.id_principio, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$("#tabla").bootstrapTable({
    ...
    columns: [
        [
            ...
            { field: 'nombre', title: 'Principio', align: 'left', valign: 'middle', sortable: true, cellStyle: bstTruncarColumna },
...
$('#agregar').click(function() {
    $('#modalLabel').html('Agregar Principios Activos');
...
$('#eliminar').click(function() {
    var id = $("#id_principio").val();
    var nombre = $("#nombre").val();

    sweetAlertConfirm({
        title: `Eliminar`,
        text: `¿Eliminar Principio Activo: ${nombre}?`,
        closeOnConfirm: false,
        confirm: function() {
            $.ajax({
                dataType: 'json',
...
function editarDatos(row) {
    resetForm("#formulario");
    $('#modalLabel').html('Editar Principio Activo');
    $('#formulario').attr('action', 'editar');
    $('#eliminar').show();
    $('#modal').modal('show');

    $("#id_principio").val(row.id_principio);
