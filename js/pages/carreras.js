        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id_carrera: row.id_carrera, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$("#tabla").bootstrapTable({
    ...
    columns: [
        [
            { field: 'id_carrera', title: 'ID Carrera', align: 'left', valign: 'middle', sortable: true, visible: false },
            { field: 'carrera', title: 'Carrera', align: 'left', valign: 'middle', sortable: true, cellStyle: bstTruncarColumna },
...
$('#agregar').click(function() {
    $('#modalLabel').html('Agregar Carrera');
