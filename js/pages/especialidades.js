var url = 'inc/especialidades-data';
        ...
        sweetAlertConfirm({
            ...
            confirm: function() {
                $.ajax({
                    ...
                    type: 'post',
                    data: { id: row.id_especialidad, estado },
                    beforeSend: function() {
                        NProgress.start();
                    },
...
$("#tabla").bootstrapTable({
    ...
    columns: [
        [
            ...
            { field: 'nombre', title: 'Nombre y Apellido', align: 'left', valign: 'middle', sortable: true },
...
$('#agregar').click(function() {
    $('#modalLabel').html('Agregar Especialidad');
...
$('#eliminar').click(function() {
    ...
    sweetAlertConfirm({
        title: `Eliminar`,
        text: `¿Eliminar la Especialidad: ${nombre}?`,
        closeOnConfirm: false,
        confirm: function() {
            $.ajax({
                dataType: 'json',
...
function editarDatos(row) {
    resetForm('#formulario');
    $('#modalLabel').html('Editar Especialidad');
    $('#formulario').attr('action', 'editar');
    $('#eliminar').show();
    $('#modal').modal('show');

    $("#id").val(row.id_especialidad);
