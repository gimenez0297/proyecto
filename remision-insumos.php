                        ...
                        <div class="col-12 pt-2">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group-sm col-md-3">
                                    ...
                                    <select id="motivo" name="motivo" class="form-control-sm" readonly required></select>
                                </div>
                                <div class="form-group-sm col-md-3">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5 col-sm-12">
                                            <label for="producto">Insumo<sup class="ml-1">[F3]</sup></label>
                                            <select id="producto" name="producto" class="form-control"></select>
                                        </div>
                                        <div class="form-group col-md-2 col-sm-12">
                                            <label for="vencimiento">Vencimiento</label>
                                            <select id="vencimiento" name="vencimiento" class="form-control"></select>
                                        </div>
