                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="nombre_corto" class="label-required">Nombre Corto</label>
                                                            <input class="form-control input-sm upper" type="text" name="nombre_corto" id="nombre_corto" autocomplete="off" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
