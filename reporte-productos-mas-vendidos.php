                    ...
                    <div class="col-12">
                        ...
                        <div id="toolbar">
                            <div class="form-inline" role="form">
                                ...
                                <!-- <div class="alert alert-info ml-2" role="alert" id="label_fraccionado">NO FRACCIONADOS</div> -->
                            </div>
                        </div>
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-3 col-sm-12">
                                                            ...
                                                            ?>
                                                            <select id="sucursal" name="sucursal" class="form-control" <?php echo $disabled; ?>>
                                                                <?php echo $option; ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <!-- <div class="form-group col-md-2 col-sm-12">
                                                            <label for="filtro_fraccionado">Fraccionado</label>
                                                            <select id="filtro_fraccionado" name="filtro_fraccionado" class="form-control sino"></select>
                                                        </div> -->
