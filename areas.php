                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="form-group col-md-12 col-sm-12">
                                                    <label for="id_area_superior">Dependencia Superior</label>
                                                    <select id="id_area_superior" name="id_area_superior" class="form-control"></select>
                                                </div>
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="area" class="label-required">Dependencia</label>
                                                            <input class="form-control input-sm upper" type="text" name="area" id="area" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
