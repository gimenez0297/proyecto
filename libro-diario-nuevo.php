                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-12 col-sm-6 required">
                                                            ...
                                                            <input class="form-control input-sm upper" type="date" name="desde" id="desde" autocomplete="off" required>
                                                        </div>
                                                        <div class="form-group col-md-12 col-sm-6">
                                                            <label for="hasta" class="label-required">Hasta</label>
                                                            <input class="form-control input-sm upper" type="date" name="hasta" id="hasta" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
