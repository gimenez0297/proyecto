                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-6 required">
                                                            ...
                                                            <input class="form-control input-sm upper" type="text" name="codigo" onkeypress="return soloNumeros(event);" id="codigo" autocomplete="off" required>
                                                        </div>
                                                        <div class="form-group col-md-12 col-sm-6 required">
                                                            <label for="nombre" class="label-required">Nombre del comprobante</label>
