                            ...
                            <div class="modal-dialog modal-md2 modal-dialog-centered modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <form class="form default-validation" id="formulario" method="post" enctype="multipart/form-data" action="">
                                        <input type="hidden" name="id_organizacion" id="id_organizacion">
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="carrera" class="label-required">Organización</label>
                                                            <input class="form-control input-sm upper" type="text" name="organizacion" id="organizacion" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group col-md-12 col-sm-12">
                                                    ...
                                                    <select id="id_sector" name="id_sector" class="form-control"></select>
                                                </div>
                                                <div class="form-group col-md-12 col-sm-12">
