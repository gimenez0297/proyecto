                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="entidad" class="label-required">Entidad</label>
                                                            <input class="form-control input-sm upper" type="text" name="entidad" id="entidad" autocomplete="off" required>
                                                        </div>
                                                        <div class="form-group col-md-12 col-sm-12">
