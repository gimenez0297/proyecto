                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="cargo" class="label-required">Categoría</label>
                                                            <input class="form-control input-sm upper" type="text" name="categoria" id="categoria" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="salario">Asignación Salarial</label>
                                                            <input class="form-control input-sm" type="text" name="salario" id="salario" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12 col-sm-12">
                                                    <label for="id_categoria_superior">Categoría Superior</label>
                                                    <select id="id_categoria_superior" name="id_categoria_superior" class="form-control"></select>
                                                </div>
                                            </div>
                                        </div>
