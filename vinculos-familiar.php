                            ...
                            <div class="modal-dialog modal-md2 modal-dialog-centered modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <form class="form default-validation" id="formulario" method="post" enctype="multipart/form-data" action="">
                                        <input type="hidden" name="id_vinculo" id="id_vinculo">
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="vinculo" class="label-required">Vínculo</label>
                                                            <input class="form-control input-sm upper" type="text" name="vinculo" id="vinculo" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
