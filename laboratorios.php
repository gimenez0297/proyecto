                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="laboratorio" class="label-required">Laboratorio</label>
                                                            <input class="form-control input-sm upper" type="text" name="laboratorio" id="laboratorio" autocomplete="off" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
