                        ...
                        <div id="toolbar">
                            <div class="form-inline" role="form">
                                ...
                                <div class="form-group">
                                    <select id="filtro_area" class="form-control"></select>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <form class="form default-validation" id="formulario" method="post" enctype="multipart/form-data" action="">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12 col-sm-12">
                                                    <label for="id_jefe">Superior</label>
                                                    <select id="id_jefe" name="id_jefe" class="form-control"></select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4 col-sm-12">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="confianza" name="confianza" value="1">
                                                        <label class="custom-control-label" for="confianza">¿Es de confianza?</label>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-8 col-sm-12">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="multiple" name="multiple" value="1">
                                                        <label class="custom-control-label" for="multiple">¿Pueden haber varias personas con el mismo Cargo ?</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
