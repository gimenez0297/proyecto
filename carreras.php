                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="carrera" class="label-required">Carrera</label>
                                                            <input class="form-control input-sm upper" type="text" name="carrera" id="carrera" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
