                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-3 col-sm-6 required">
                                                            <label for="tipo_movimiento" class="label-required">Tipo Movimiento</label>
                                                        ...
                                                        <div class="form-group col-md-3 col-sm-6 required">
                                                            <label for="nro_comprobante" class="label-required">Nro Comprobante</label>
                                                            <input class="form-control input-sm upper" type="text" name="nro_comprobante" id="nro_comprobante" autocomplete="off" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-3 col-sm-6 required">
                                                            ...
                                                            <input class="form-control input-sm upper text-right" type="text" placeholder="0" name="importe" id="importe" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)" value="0">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12 col-sm-6">
                                                            ...
                                                            <input class="form-control input-sm upper" type="text" name="observacion" id="observacion" autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
