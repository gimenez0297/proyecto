                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="tipo_gasto" class="label-required">Tipo</label>
                                                            <input class="form-control input-sm upper" type="text" name="tipo_gasto" id="tipo_gasto" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
