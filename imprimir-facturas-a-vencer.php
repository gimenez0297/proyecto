<?php
        ...
        <table class="tc" width="100%">
            <thead>
                <tr>
                    ...
                    <td class="tc-axmw">Total Egresos</td>
    ...
    if (in_array('descripcion',$columnas)) {
        $mpdf->writehtml('<th class="tg-zqap">Descripción</th>');
    }
    ...
    foreach ($rows as $r) {
        ...
        if (in_array('descripcion',$columnas)) {
            $mpdf->writehtml('<td class="tg-1x3m" style="text-align:center;">'.$descripcion.'</td>');
        }
        if (in_array('fecha_emision',$columnas)) {
        ...
        if (in_array('razon_social',$columnas)) {
            $mpdf->writehtml('<td class="tg-1x3m" style="text-align:left;">'.$razon_social.'</td>');
        }
        if (in_array('condicion',$columnas)) {
