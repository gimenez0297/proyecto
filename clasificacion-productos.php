                            ...
                            <div class="modal-dialog modal-md2 modal-dialog-centered modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <form class="form default-validation" id="formulario" method="post" enctype="multipart/form-data" action="">
                                        <input type="hidden" name="id_clasificacion_producto" id="id_clasificacion_producto">
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="clasificacion" class="label-required">Clasificación</label>
                                                            <input class="form-control input-sm upper" type="text" name="clasificacion" id="clasificacion" autocomplete="off" required="">
                                                        </div>
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="grupo" class="label-required">Grupo</label>
