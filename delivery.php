                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-6">
                                                            <label for="id_distrito" class="label-required">Ciudad</label>
                                                            <select id="id_distrito" name="id_distrito" class="form-control" required></select>
                                                        </div>
                                                        <div class="form-group col-md-12 col-sm-6">
                                                            <label for="precio" class="label-required">Precio</label>
                                                            <input class="form-control input-sm upper text-right" type="text" placeholder="0" name="precio" id="precio" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)" value="0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
