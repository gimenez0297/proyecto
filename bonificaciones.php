                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 col-sm-12">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12 col-sm-12">
                                                            <label for="porcentaje" class="label-required">Porcentaje</label>
                                                            <input class="form-control input-sm text-right" type="text" name="porcentaje" id="porcentaje" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)"  required>
                                                        </div>
                                                    </div>
                                                </div>
